...
const AddProductForm = ({ onClose, callBack }) => {
  ...
  const handleAddProduct = async (e) => {
    ...
    const fetchData = await fetch(SummaryApi.addProduct.url, {
      method: "POST",
      credentials: "include",
      headers: {
  ...
  return (
    <div className="absolute z-10 -top-20 left-[50%] translate-x-[-50%] flex flex-col gap-2 min-w-[700px] p-4 shadow bg-white border">
      <button
